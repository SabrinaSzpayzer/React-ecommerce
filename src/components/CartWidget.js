                            ...
                            return (
                                <li key={cartProduct.id}>
                                    <div className='cartWidgetCard'>
                                        ...
                                        <button className="btn btn-light btnCartWidget" onClick={() => deleteProduct(cartProduct)}><FontAwesomeIcon icon={faTrash} /></button>
                                    </div>
                                </li> 
                            )
                        })}
                        <li><button className="btn btn-secondary btnCartWidget" onClick={() => clear()}>Vaciar Carrito</button></li>
                        <li><Link to={'/cart'}><button type="button" className="btn btn-secondary btnCartWidget">Finalizar Compra</button></Link></li>
                    </ul>
                </div>  
            </div>   
        )
